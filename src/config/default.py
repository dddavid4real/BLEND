...
# Added configs for privileged knowledge distillation
...
_C.TRAIN.SOFT_DISTILLATION = False
_C.TRAIN.FEATURE_DISTILLATION = False
_C.TRAIN.CORRELATION_DISTILLATION = False
_C.TRAIN.GRADIENT_DISTILLATION = False
#*
