...
from src.run_LUPI import prepare_config
from src.runner_LUPI import Runner
...
#**
if dataset_name == 'mc_maze_LUPI':
    dataset_name = 'mc_maze'
elif dataset_name == 'mc_maze_LUPI_soft':
    dataset_name = 'mc_maze'
#**
...
# # After creating output_dict and before calling evaluate
# print("Target dict structure:")
# print(json.dumps(target_dict, indent=2, default=str))
# print("\nOutput dict structure:")
# print(json.dumps(output_dict, indent=2, default=str))

# # Then call evaluate
# result = evaluate(target_dict, output_dict)
